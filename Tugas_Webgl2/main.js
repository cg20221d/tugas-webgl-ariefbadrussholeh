...
import { vertices_e, indices_e } from "./vertices.js";
...
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices_e), gl.STATIC_DRAW);

var indexBuffer = gl.createBuffer();
gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, indexBuffer);
gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(indices_e), gl.STATIC_DRAW);
...
function render() {
  ...
  gl.drawElements(gl.TRIANGLES, indices_e.length, gl.UNSIGNED_SHORT, 0);
